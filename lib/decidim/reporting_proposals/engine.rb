  ...
  module ReportingProposals
    ...
    class Engine < ::Rails::Engine
      ...
      config.to_prepare do
        ...
        Decidim::Meetings::CloseMeetingForm.include(Decidim::ReportingProposals::MapIncludedProposalsForFormOverride)
        Decidim::Meetings::Admin::CloseMeetingForm.include(Decidim::ReportingProposals::MapIncludedProposalsForFormOverride)
        Decidim::Budgets::Admin::ProjectForm.include(Decidim::ReportingProposals::MapIncludedProposalsForFormOverride)
        Decidim::Elections::Admin::AnswerForm.include(Decidim::ReportingProposals::MapRelatedProposalsForFormOverride) if defined?(Decidim::Elections::Admin::AnswerForm)
