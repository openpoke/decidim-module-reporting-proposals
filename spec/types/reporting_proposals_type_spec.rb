...
module Decidim::ReportingProposals
  describe ReportingProposalsType, type: :graphql do
    include_context "with a graphql class type"
    let(:model) { create(:reporting_proposals_component) }
    ...
    describe "proposal" do
      ...
      context "when the proposal doesn't belong to the component" do
        let!(:proposal) { create(:proposal, component: create(:reporting_proposals_component)) }
