...
checksums = [
  {
    ...
    files: {
      ...
      "/lib/decidim/form_builder.rb" => %w(91c55f8197a9e3892e94f5c13ca40905 3ea9c3c51ea6e5e54d293326a529d27a),
  ...
  },
  {
    ...
    files: {
      "/app/controllers/decidim/proposals/proposals_controller.rb" => %w(6f73c3cad3c713358535c92e2ed84f60 81075a969be2732d21f244eff3c4c56e),
      ...
      "/app/views/decidim/proposals/admin/proposals/_proposal-tr.html.erb" => %w(e0a162954ca45ab6b3d71e61635eddbd b1076d75afb140ded26d4837618f2af5),
      "/app/views/decidim/proposals/admin/proposals/show.html.erb" => "95f1912f51dcdb4034e61c9ca8d2d315",
...
describe "Overriden files", type: :view do
  checksums.each do |item|
    ...
    item[:files].each do |file, signature|
      signature = [signature] unless signature.is_a?(Array)
      it "#{spec.gem_dir}#{file} matches checksum" do
        expect(signature).to include(md5("#{spec.gem_dir}#{file}"))
      end
    end
  end
